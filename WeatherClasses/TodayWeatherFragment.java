...
public class TodayWeatherFragment extends Fragment {
    ...
    TextView txt_cityName, txt_humidity, txt_sunrise, txt_sunset, txt_pressure,
            txt_temperature, txt_description, txt_dateTime, txt_geoCoords;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_geoCoords = (TextView) itemView.findViewById(R.id.txt_geoCoords);
        ...
        compositeDisposable.add(mService.getWeatherByLatLng(String.valueOf(Common.current_location.getLatitude()),
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_temperature.setText(new StringBuilder(String.valueOf(Math.round(weatherResult.getMain().getTemp())))
                                .append("°C").toString());
                        txt_dateTime.setText(Common.convertUnixToDate(weatherResult.getDt()));
                        ...
                        txt_geoCoords.setText(new StringBuilder(weatherResult.getCoord().toString()).toString());
